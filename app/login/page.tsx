      ...
      <nav className="fixed top-0 w-full bg-black/80 backdrop-blur border-b border-gray-800" style={{ zIndex: 40 }}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between relative z-10">
          ...
          <div className="flex items-center gap-3">
            <Button variant="ghost" size="sm" className="text-gray-400 hover:text-white hover:bg-white/10" disabled>
              Log In
            </Button>
            <Button
              size="sm"
        ...
        <div className="w-full max-w-md">
          <Card className="p-8 bg-black/30 border border-white/20 backdrop-blur-md">
            <div className="mb-8">
              ...
              <p className="text-gray-400">Sign in to your CodeRefine account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                {isLoading ? (
                  ...
                  <>
                    Sign In <Sparkles className="ml-2 w-5 h-5" />
                  </>
                )}
              </Button>
            </form>
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-400 text-sm">
                ...
                <Link href="/signup" className="text-white hover:text-gray-200 font-semibold transition duration-300">
                  Sign up
                </Link>
              </p>
            </div>
